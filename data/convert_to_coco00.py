...
CLASSES = ('Red', 'Green', 'Yellow', 'Off', 'RedLeft','GreenLeft',  'YellowLeft', 'RedRight', 'GreenRight',
                'YellowRight', 'RedStraight', 'GreenStraight', 'YellowStraight',
                'RedThreeArrow', 'GreenThreeArrow', 'YellowThreeArrow', 'TimerOutside', 'Cone', 'TriangleWarningSign',
                'Construction', 'Car', 'Person', '4ABicycle', '4AMotorcycle')
# traffic3_CLASSES = ('traffic3', 'traffic3-occ-partially', 'traffic3rev', 'traffic3rev-occ-partially')
# traffic4_CLASSES = ('traffic4', 'traffic4-occ-partially', 'traffic4y', 'traffic4y-occ-partially')
# dets_CLASSES = CLASSES + traffic3_CLASSES + traffic4_CLASSES
dets_CLASSES = CLASSES

def parse_args():
    parser = argparse.ArgumentParser()
    # parser.add_argument('--json_dir', type=str, default='./test_data/20200831audo/label')
    # parser.add_argument('--txt_path', type=str, default='./test_data/20200831audo/train.txt')
    # parser.add_argument('--output_json', type=str, default='./test_data/20200831audo/sxp_train_val_2000.json')
    parser.add_argument('--json_dir', type=str, default='./20200831audo/label')
    parser.add_argument('--txt_path', type=str, default='./20200831audo/val.txt')
    parser.add_argument('--output_json', type=str, default='./20200831audo/sxp_train_val_2000.json')
